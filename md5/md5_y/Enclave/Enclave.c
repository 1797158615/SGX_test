...
__attribute__((__annotate__("SGX")))
void md5_finish( md5_context *ctx, uint8 *digest )
{
    uint32 last, padn;
    uint32 high, low;
    uint8 msglen[8];
...
__attribute__((__annotate__("SGX"), __annotate__("memsize(4, 16)"), __annotate__("TAFUN")))
void d_md5(int *repeatp, unsigned char *md5sum )
{
